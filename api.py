...
class APIPlayerCharacters(APIBase):
    def get(self, key):
        ...
        if _character is not None and _character.class_name() == 'Player':
            r = API200.copy()
            logging.info(_trace + "API200 = " + str(API200))
            r[MSG] = 'A hero returns!'
            r[MOD] = _character.class_name()
            r[RES] = [character.getJSONPlayer(_character)]
        else:
            r = API404
...
class APITemplates(APIBase):
    def get(self, _class):
        ...
        if _class == 'pc':
            ...
            r[MOD] = 'PlayerCharacterTemplates'
            r[RES] = data
            ...
            r[MOD] = 'NonPlayerCharacterTemplates'
            r[RES] = data
